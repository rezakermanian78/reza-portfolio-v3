...
export const WhatsappIcon = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M12 0C5.373 0 0 5.373 0 12c0 2.126.557 4.126 1.532 5.862L.054 23.5l5.788-1.517A11.94 11.94 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 0 1-5.002-1.366l-.359-.214-3.733.979.997-3.645-.234-.374A9.818 9.818 0 1 1 12 21.818z"/>
  </svg>
);
